...
public class ConsolidatedReportsPageWriter extends ReportsPage {
	public static void menuLink(PrintWriter paramPrintWriter, int paramInt) {
		...
		if (paramInt == 1)
			...
			for (int i = 1; i <=paramInt ; i++) {
			  ...
			  Directory.RUNName + (j-i+1) + Directory.SEP + "CurrentRun.html\" >" + (j-i+1) + "Run "  +
			  " </a></li>\n");
			  paramPrintWriter.println("");
			  break; }
	...
	public static void header(PrintWriter paramPrintWriter) {
		paramPrintWriter.println(
				...
				+ "\" height=\"70\" width=\"140\" /> " + "<br/>"
				+ "</td>\n" + "                <td id=\"headertext\">\n"
				+ "                    " + ReportLabels.HEADER_TEXT.getLabel() + " \n"
				+ "<div style=\"padding-right:20px;float:right\"><img src=\"../HTML_Design_Files/IMG/KYC.png"
...
//						+ "</td>\n" + "                <td id=\"headertext\">\n"
//						+ "                    " + ReportLabels.HEADER_TEXT.getLabel() + " \n"
//						+ "<div style=\"padding-right:20px;float:right\"><img src=\"../HTML_Design_Files/IMG/snapimage1.png"
//					    +"\" height=\"70\" width=\"140\" /> </i></div>"
//						+ "                </td>\n" + "</tr>\n" + "");
//	}
